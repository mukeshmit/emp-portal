...
<div class="campaigns-form">
    ...
    <?php //= $form->field($model, 'mc_camp_list_id')->textInput()->label(false); ?>

    <?= $form->field($model, 'mc_camp_id')->textInput()->label(false); ?>

    <?= $form->field($model, 'created_by')->textInput()->label(false); ?>
